...
export interface HanaCustomColumnInnerConfig {
	customTypeValues: CustomTypeValues;
}

export class HanaCustomColumnBuilder<T extends ColumnBuilderBaseConfig<'custom'>> extends HanaColumnBuilder<
	T,
	{
...
> {
	static override readonly [entityKind]: string = 'HanaCustomColumnBuilder';
	...
	constructor(
		...
		super(name, 'custom', 'HanaCustomColumn');
...
export class HanaCustomColumn<T extends ColumnBaseConfig<'custom'>> extends HanaColumn<T> {
	static override readonly [entityKind]: string = 'HanaCustomColumn';
	...
	constructor(
		table: HanaTable<any>,
		config: HanaCustomColumnBuilder<T>['config'],
	) {
		super(table, config);
...
/**
 * Custom hana database data type generator
 */
export function customType<T extends CustomTypeValues = CustomTypeValues>(
	customTypeParams: CustomTypeParams<T>,
		...
		<TConfig extends Record<string, any> & T['config']>(
			fieldConfig: TConfig,
		): HanaCustomColumnBuilder<ConvertCustomConfig<T>>;
		(
			dbName: string,
	...
	}
{
	return (
		...
		return new HanaCustomColumnBuilder(name, config, customTypeParams);
	};
}
